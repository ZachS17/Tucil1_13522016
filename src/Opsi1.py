...
arrtoken = [stringtoken[i:i+2] for i in range(0, len(stringtoken), 2)] # ubah string token jadi array
...
for i in range (jsekuens):
    ...
    for i in range (baris):
        ...
        for j in range (kolom):
            elemen = random.sample(arrtoken,1)
            randomarray.append(elemen)
        matriks.append(randomarray)
